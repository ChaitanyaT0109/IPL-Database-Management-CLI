DROP DATABASE IF EXISTS CRICSTAR1;

CREATE DATABASE CRICSTAR1;
...
CREATE TABLE POINTS_TABLE (
    LEAGUE_ID INT,
    TEAM_ID INT,
    MATCH_PLAYED INT CHECK(MATCH_PLAYED>=0),
    MATCHES_WON INT CHECK(MATCHES_WON>=0),
    MATCHES_LOST INT CHECK(MATCHES_LOST>=0),
...
(2, 'PAYTM TRI-SERIES', '2024-11-22', '2024-01-07', 'INDIA');
...
CREATE VIEW PROPER_MATCH AS
SELECT 
    M.MATCH_ID,
    GROUP_CONCAT(t.TEAM_NAME SEPARATOR ' vs ') AS MATCH_TEAMS
FROM 
    MATCHES M
JOIN 
